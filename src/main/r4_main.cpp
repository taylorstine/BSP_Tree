...
int drawGLScene( void )
{
   ...
   glDrawElements(GL_TRIANGLES, meshdata2.num_triangles * 3, GL_UNSIGNED_INT, meshdata2.triangles); 
    ...
    for(int i =0; i < mesh.triangles.size(); i++){
      ...
      glVertex3f(mesh.vertices[mesh.triangles[i].vertices[0]].position[0],
		 mesh.vertices[mesh.triangles[i].vertices[0]].position[1],
		 mesh.vertices[mesh.triangles[i].vertices[0]].position[2]);
      glVertex3f(mesh.vertices[mesh.triangles[i].vertices[1]].position[0],
		 mesh.vertices[mesh.triangles[i].vertices[1]].position[1],
		 mesh.vertices[mesh.triangles[i].vertices[1]].position[2]);
      glVertex3f(mesh.vertices[mesh.triangles[i].vertices[2]].position[0],
		 mesh.vertices[mesh.triangles[i].vertices[2]].position[1],
		 mesh.vertices[mesh.triangles[i].vertices[2]].position[2]);
      glEnd();
    }
    */
...
void copy_mesh_data(){
  Mesh mesh1 = mesh[0];
  Mesh mesh2 = mesh[1];
  MeshData meshdata1 = meshdata[0];
  MeshData meshdata2 = meshdata[1];
...
int main( int argc, char **argv )
{
  mesh.push_back(Mesh());
  mesh.push_back(Mesh());
  mesh[0].filename = "models/pool.obj";
  mesh[1].filename = "models/cube.obj";
  if(argc > 1){
